          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center space-x-1 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 transition-colors"
              >
                  ...
                  {LANGUAGE_OPTIONS.map((option) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center space-x-2 ${
                        language === option.code ? 'bg-indigo-50 dark:bg-indigo-900 text-indigo-600 dark:text-indigo-400' : 'text-gray-700 dark:text-gray-300'
                      }`}
                    >
            ...
            {user ? (
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 transition-colors"
                >
